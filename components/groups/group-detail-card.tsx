...
import { GroupDocumentLinks } from "@/components/groups/group-document-links"
import { latestConstitutionFileUrl } from "@/utils/groups/latestConstitutionUrl"
...
export function GroupDetailCard({ group }: GroupDetailCardProps) {
  ...
  const constitutionUrl = latestConstitutionFileUrl(group)
  const registrationDocuments = group.registrationDocuments ?? []
